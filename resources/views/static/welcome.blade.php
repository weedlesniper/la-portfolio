...
<head>
    ...
    @else
        <style>/* ... your fallback styles ... */</style>
    @endif
</head>
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] min-h-screen flex flex-col">
    ...
    <main class="flex-1 flex items-center lg:justify-center p-6 lg:p-8">
        <section class="w-full max-w-4xl grid lg:grid-cols-2 gap-6">
            <!-- Intro -->
            <div class="p-6 lg:p-10 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-lg">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm">Laravel, Livewire/Blade, Tailwind • Python, FastAPI • SQLite/Postgres • Git & CI</p>
                    </div>
                </div>
    ...
    <!-- About -->
    <section id="about" class="w-full max-w-4xl mx-auto px-6 lg:px-8 pb-10">
        <h2 class="text-xl font-semibold mb-3">About</h2>
        <p class="text-sm text-[#706f6c] dark:text-[#A1A09A]">
            I enjoy solving real problems with small, focused tools. I’m currently refining an OCR/video pipeline,
            experimenting with OAuth providers, and building out a personal projects stack that’s simple to host.
        </p>
    </section>
